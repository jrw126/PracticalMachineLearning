...
corrgram(training[, idx], lower.panel = panel.shade, upper.panel = NULL, text.panel = panel.txt, main = "Correlogram of Numeric Variables")
...
# Fit a model using K nearest neighbors
